...
import { loadContent, mergeStructureWithContent, detectDeletedFiles, extractContentFromStructure, injectAndSort } from './content';
...
// --- Logger Helper ---
const Log = {
    header: (version: string) => console.log(`\n🚀 CodeSlides Generator v${version} (TS)\n====================================`),
